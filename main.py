...
Goals: Hit all of the green mobs 
...
class Game:
    ...
    def __init__(self):
        ...
        pg.init()
        pg.mixer.init()
        # sets up the screen the game will be displayed in pygame
    ...
    def new(self):
        ...
        self.plat1 = Platform(WIDTH, 50, 0, HEIGHT-50, (GREEN), "normal")
        # this is a platform so that the player lands on a platform every game
        self.plat2 = Platform(200, 30, 200, 400, (BLACK), "normal")
        ...
        # the reason there is a -75 next to the height is so that it is not inside of the bottom platform
        self.plat3 = Platform(100, 30, randint(0,WIDTH), randint(0,HEIGHT-75), (PINK), "normal")
        self.plat4 = Platform(150, 30, randint(0,WIDTH), randint(0,HEIGHT-75), (TEAL), "normal")
        self.plat5 = Platform(175, 30, randint(0,WIDTH), randint(0,HEIGHT-75), (BLUE), "normal")
        self.plat6 = Platform(175, 30, randint(0,WIDTH), randint(0,HEIGHT-75), (PURPLE), "normal")
        ...
        for event in pg.event.get():
            ...
            if event.type == pg.KEYDOWN:
                if event.key == pg.K_SPACE:
                    # what to do when keybind is pressed
                    self.player.jump()
    def update(self):
